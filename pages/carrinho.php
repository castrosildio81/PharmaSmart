...
$sql = "SELECT u.id as usuario_id, u.morada, c.medicamento_id, c.id, m.nome, m.imagem, m.preco, c.quantidade
            FROM carrinho c
    ...
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <button onclick="window.location.href='../funcoes/finalizar_compra.php'" class="checkout">
                    Finalizar Compra
                </button>
